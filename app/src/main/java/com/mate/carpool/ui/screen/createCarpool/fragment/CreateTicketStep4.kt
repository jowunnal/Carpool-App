...
@AndroidEntryPoint
class CreateTicketStep4 :
    BaseFragment<CreateTicketViewModel, FragmentCreateCarpoolTicketStep4Binding>() {

    override val viewModel: CreateTicketViewModel by hiltNavGraphViewModels(R.id.createTicket)

    override fun getViewBinding(): FragmentCreateCarpoolTicketStep4Binding =
        FragmentCreateCarpoolTicketStep4Binding.inflate(layoutInflater)
